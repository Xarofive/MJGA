...
<p>Для лучшего понимания коллекций ArrayList и HashMap в Java прослушайте аудиоподкаст:</p>
<p style="margin: 15px 0;"><a href="https://drive.google.com/file/d/1LZa_AGKk5lV6BYVsb_zd1cOOj_LmdiIp/view?usp=sharing" style="display: inline-block; background: #1565c0; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;" target="_blank">🎧 Прослушать о коллекциях ArrayList и HashMap</a></p>

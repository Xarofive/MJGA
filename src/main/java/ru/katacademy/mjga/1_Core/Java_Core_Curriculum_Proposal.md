...
| Maven/Gradle | Нет | Нет, новая тема | Packages, classes, Git useful, завершенная базовая ООП-линия |
...
| Maven | Да | Модуль 5 | Packages, classes, Git желательно, завершенная базовая ООП-линия |

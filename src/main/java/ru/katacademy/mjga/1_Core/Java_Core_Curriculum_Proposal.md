...
Документ актуализирован 9 июня 2026 года и проектирует Java Core как прямое продолжение завершенного Java Base на основе файла `../0_Base/java_base_student_portrait.md`.
...
- каталоги модулей `1.1-1.10` созданы, но пока не содержат учебных материалов;
- разделы ниже для модулей `1.1-1.10` остаются целевой программой, а не описанием уже готового контента.
